    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        save.setOnClickListener(v -> {
            if(!extras.getBoolean("edit")){
                Toast.makeText(SALUTE_p3.this,"You have not complete other required fields yet", Toast.LENGTH_SHORT).show();
            }else{
                Intent intent = new Intent(SALUTE_p3.this, ReviewSALUTE.class);
                extras.putString("location", editText.getText().toString());
                intent.putExtras(extras);
                startActivity(intent);
            }
